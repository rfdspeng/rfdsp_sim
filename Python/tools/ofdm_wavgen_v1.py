...
def ofdm_wavgen(nsym,bw,scs,num_sc,start_sc,modorder,en_tprecode,ncp=0,wola=0,seed=[]):
    ...
    d = {}
    # Demodulation params
    d['fs'] = fs; d['nfft'] = nfft; d['ncp'] = ncp; d['nrb'] = nrb; d['nsym'] = nsym
    d['bw'] = bw; d['scs'] = scs; d['num_sc'] = num_sc; d['start_sc'] = start_sc
    d['modorder'] = modorder; d['en_tprecode'] = en_tprecode; d['tone_idx'] = tone_idx
    d['wola_len'] = wola_len
    # Waveforms
    d['x'] = x; d['x_standard'] = x_standard
    return d
